...
> Design and implement a multi-floor parking lot supporting different
> vehicle types.

**Key concepts:** - Domain modeling (ParkingLot, Floor, Slot, Ticket,
Vehicle) - Strategy pattern for fee calculation - Service orchestration
with ParkingManager - Edge case handling (full lot, invalid ticket,
double exit) - JUnit tests - UML & Sequence diagrams
